        ...
        [
            html.Div(
                [
                    ...
                    html.P(
                        "Monitoreo en tiempo real de variables de proceso y condición",
                        ...
                        [
                            ...
                            dbc.Row(
                                [
                                    dbc.Col(
                                        html.Div(
                                            [html.Div(id="eq-health-gauge")], className="chart-card"
                                        ),
                                        md=3,
                                    ),
                                    dbc.Col(
                                        html.Div(
                                            [html.Div(id="eq-kpi-strip")], className="chart-card"
                                        ),
                                        md=9,
                                    ),
                                ],
                                ...
                                [
                                    dbc.Col(
                                        html.Div(
                                            [
                                                html.Div(
                                                    "Vibración (mm/s)", className="chart-title"
                                                ),
                                                dcc.Graph(
                                                    id="eq-chart-vibration",
                            ...
                            dbc.Row(
                                [
                                    ...
                                    dbc.Col(
                                        html.Div(
                                            [
                                                html.Div("Potencia (kW)", className="chart-title"),
                                                dcc.Graph(
                                                    id="eq-chart-power",
                                                    config={"displayModeBar": False},
                                                ),
